...
<body>
    <header>
        <a href="mainpage.php" style = "padding : 25px"> <img class="logo" src="orangeone.png" alt="the odin project logo"  ></a>
    ...
    <section>
        <section>
            ...
            <img class="picture" src="https://images.unsplash.com/photo-1631120821877-11c76d4671a6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzB8fGluZGlhbiUyMHN3ZWV0fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="the odin project logo"><img>
            ...
            <div class="row">
                ...
                <div class="column">
                    <div class="tilt-box-wrap">
                        ...
                        <span class="t_over"></span>
                        <div class="tilt-box" >
                            <strong><h2>Tradition wise</h2></strong>
                        </div>
                    </div>
                </div>
                <div class="column">
                    <div class="tilt-box-wrap">
                        ...
                        <span class="t_over"></span>
                        <div class="tilt-box" >
                            <strong><h2>Region wise</h2></strong>
                        </div>
                    </div>
                </div>
